...
int main() {
    ...
    float base_accel[2], display_accel[2];
    ...
    while (1) {
        ...
        read_accel_value(base_accel_paths[0], display_accel_scale_path, &base_accel[0]);
        read_accel_value(base_accel_paths[2], display_accel_scale_path, &base_accel[1]);

        read_accel_value(display_accel_paths[1], display_accel_scale_path, &display_accel[1]);
        read_accel_value(display_accel_paths[2], display_accel_scale_path, &display_accel[2]);
        ...
        */
        ...
        float determinant = base_accel[0] * display_accel[1] - base_accel[1] * display_accel[0];
